...
USER_NAME = os.environ['USER_NAME'] # 'gameboyjacks'
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    justify_format(root, 'repo_data', repo_data, 18)
    justify_format(root, 'contrib_data', contrib_data)
    justify_format(root, 'follower_data', follower_data, 2)
    ...
    justify_format(root, 'loc_del', loc_data[1], 3)
...
def justify_format(root, element_id, new_text, length=0):
    ...
    dot_string = ' ' * max(0, length - len(new_text))
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2002, 6, 25))
